...
<figure>
<img src="immagini/01_valle_disperazione.png">
<figcaption>La valle della disperazione. L'ostacolo non è il ritorno dell'investimento, è il tratto in cui l'azienda sta peggio di prima.</figcaption>
</figure>
...
<figure>
<img src="immagini/03_costruzione_esecuzione.png">
<figcaption>Lo stesso modello, due collocazioni diverse: dentro ogni transazione, oppure a monte a produrre artefatti deterministici.</figcaption>
</figure>
...
<figure>
<img src="immagini/02_architettura.png">
<figcaption>Da integrazioni punto a punto a uno strato di accesso comune, governato da un modello semantico di riferimento.</figcaption>
</figure>
...
Il rischio è una cosa ben diversa. Cresce senza segnale e poi si tramuta di colpo in un problema o in una catastrofe.

<figure>
<img src="immagini/04_tco_rischio.png">
<figcaption>Il costo è misurato e rassicurante; il rischio cresce lo stesso, non osservato. L'incidente non lo aumenta: lo rende visibile. Il piano di remediation lo abbatte, ma non tocca il meccanismo che lo genera.</figcaption>
</figure>
