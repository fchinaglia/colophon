...
# There is no link to the files here: this page travels inside the bundle, where the
# files it would point at are already in the reader's hands, beside verify.html.
